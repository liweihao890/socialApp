				...
				<view class="uni-uploader__files">
					<block v-for="(image, index) in imageList" :key="index">
						<view class="uni-uploader__file position-relative">
							...
							:data-src="image" @tap="previewImage" mode="aspectFill"></image>
							<view class="text-white position-absolute top-0 right-0 px-1 rounded" 
							style="background-color: rgba(0,0 ,0 ,0.5) ;" @click="deleteImage(index)">
